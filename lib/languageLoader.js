...
module.exports.load = function (languageCode) {
	if (languageCache[languageCode])
		return languageCache[languageCode];
};

// Parse the Accept-Language header value, which often looks like: "en-US,en;q=0.8,zh-TW;q=0.6,zh;q=0.4,zh-CN;q=0.2";
